...
class TestimoniesControllerTest < ActionController::TestCase
  ...
  test "should create testimony" do
    assert_difference('Testimony.count') do
      post :create, testimony: { age_group_id: @testimony.age_group_id, disorder_id: @testimony.disorder_id, gender_id: @testimony.gender_id, testimony: @testimony.testimony, title: @testimony.title }
    end
  ...
  test "should update testimony" do
    patch :update, id: @testimony, testimony: { age_group_id: @testimony.age_group_id, disorder_id: @testimony.disorder_id, gender_id: @testimony.gender_id, testimony: @testimony.testimony, title: @testimony.title }
    assert_redirected_to testimony_path(assigns(:testimony))
  end
